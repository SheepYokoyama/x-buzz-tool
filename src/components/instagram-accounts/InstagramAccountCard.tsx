    ...
    >
      ...
      {account.is_active && (
        <span
          ...
          style={{ background: 'rgba(236,72,153,0.15)', color: '#db2777', border: '1px solid rgba(236,72,153,0.25)' }}
        >
        ...
        <div className="relative shrink-0">
          {account.profile_image_url ? (
            ...
            <div
              ...
              style={{
                background: account.is_active ? 'rgba(236,72,153,0.15)' : 'rgba(15,23,42,0.05)',
                border: account.is_active ? '1px solid rgba(236,72,153,0.2)' : '1px solid rgba(15,23,42,0.08)',
                color: account.is_active ? '#db2777' : '#64748b',
              }}
            >
              <User size={18} />
            </div>
        ...
        <div className="ml-auto flex items-center gap-1.5">
          {onRefresh && (
            <button
              ...
              style={{ background: 'rgba(236,72,153,0.07)', border: '1px solid rgba(236,72,153,0.15)', color: '#db2777' }}
